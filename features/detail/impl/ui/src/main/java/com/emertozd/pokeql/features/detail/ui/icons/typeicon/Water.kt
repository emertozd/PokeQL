...
public val TypeIcon.Water: ImageVector
    get() {
        if (com.emertozd.pokeql.features.detail.ui.icons.typeicon._water != null) {
            return com.emertozd.pokeql.features.detail.ui.icons.typeicon._water!!
        }
        com.emertozd.pokeql.features.detail.ui.icons.typeicon._water = Builder(name = "Water", defaultWidth = 1000.0.dp, defaultHeight = 1000.0.dp,
